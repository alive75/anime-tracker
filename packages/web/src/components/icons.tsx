...
export const TvIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m-3.75-3.75v3.75m-3.75-3.75h15a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H5.25A1.5 1.5 0 0 0 3.75 6v9.75a1.5 1.5 0 0 0 1.5 1.5Zm4.5-6.75h.008v.008h-.008v-.008Zm2.25.008h.008v.008h-.008v-.008Zm2.25.008h.008v.008h-.008v-.008Z" />
    </svg>
);
